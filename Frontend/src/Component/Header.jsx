  ...
  return (
    <>
      ...
      <header className="bg-white text-gray-900  sticky top-0  font-[500] shadow-lg z-50 items-center justify-center">
        <div className="relative w-full flex justify-between max-w-7xl mx-auto px-4 items-center py-0">
          <Link to="/">
            <img src={logo} alt="Dr Manas logo" className='w-[15rem] lg:w-[15rem] h-auto object-cover ' />
          </Link>

          {/* Desktop Menu */}
          <nav className="hidden relative lg:flex  lg:text-[1rem] text-[1.1rem] xl:text-[1rem] items-center px-2 lg:justify-around lg:gap-8" aria-label="Main Navigation">
            ...
            <Link to="/about-dr-manas-aggarwal" className={`relative flex items-center gap-1 transition-all duration-300 hover:text-primary ${location.pathname.startsWith('/about') ? 'text-primary' : ''}`}>
              About
            </Link>
        ...
        >
          <div className="flex justify-between items-center p-5 border-b">
            ...
            <button onClick={toggleMenu} aria-label="Open Menu" className="text-gray-700 focus:outline-none">
          ...
          <div className="p-6 space-y-6 text-lg font-medium text-gray-700">
            ...
            <NavLink to="/about-dr-manas-aggarwal" className="block hover:text-teal-600" onClick={toggleMenu}>
              About Us
            </NavLink>
